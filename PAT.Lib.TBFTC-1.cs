...
namespace PAT.Lib {
    ...
    public class BManagementNode : ExpressionValue {
        ...
        public int mNumFailure;
        public int mWaitingTime;
        public int numParticipated = 0;
        public int numBProposed = 0;
        public int round;
        public int eDeposit;
        ...
        public BManagementNode(int _mDeposit, int _mNumActivities) {
            mDeposit = _mDeposit;
            mNumActivities = _mNumActivities;
        }
        
        public BManagementNode(int _mIdentifier, int _mDeposit, int _mNumActivities) {
            mIdentifier = _mIdentifier;
            mDeposit = _mDeposit;
            mNumActivities = _mNumActivities;
        }
        
        public BManagementNode(int _mIdentifier, int _mDeposit, int _mNumActivities, int _mWaitingTime) {
            mIdentifier = _mIdentifier;
            mDeposit = _mDeposit;
            mNumActivities = _mNumActivities;
        ...
        public BManagementNode(int _mIdentifier, int _mDeposit, int _mNumActivities, int _mNumFailure, int _mWaitingTime) {
            mIdentifier = _mIdentifier;
            mDeposit = _mDeposit;
            mNumActivities = _mNumActivities;
        ...
        public void SetMDeposit(int _mDeposit) {
            mDeposit = _mDeposit;
        }
        ...
        public void AddAmount(int _mDeposit) {
            mDeposit = this.mDeposit + _mDeposit;
        }
        
        public int SubmitMDeposit(int _deposit) {
            eDeposit = _deposit;
            return eDeposit;
        }
        
        public void SetNumBGAttempts(int _mNumActivities) {
            mNumActivities = _mNumActivities;
        }
        
        public void IncNumParticipation(int _numParticipated){
        ...
        public int GetNumBProposed(){
        	return numBProposed;
        }
        
        public void SetNumBProposed(int _num){
        	numBProposed = numBProposed + _num;
        }
        
        public void IncNumBProposed(int _num){
        	numBProposed = numBProposed + _num;
        }
        
        public int GetNumBGAttempts() {
            return mNumActivities;
        }
        
        public void IncNumBGAttempts(int _mNumActivities) {
        ...
        public void SetNumFailures(int f) {
            mNumFailure = f;
        }
        
        public void IncNumFailures(int f) {
        ...
        public void SetWaitingTime(int _mWaitingTime) {
            mWaitingTime = _mWaitingTime;
        }
        
        public void IncWaitingTime(int _mWaitingTime) {
	...
	public class BManagementNodes : ExpressionValue {
        ...
        public int GetTotalDeposit() {
         ...
         public int GetTNumBGAttempts() {
            int totalBGAttempts = 1;
            foreach (BManagementNode bm in bmlist) {
     ...
     public class ValidatorNode : ExpressionValue {
        ...
        public int vDeposit;
        public int vNumActivities;
        public int vNumFailure;
        public int vWaitingTime;
        public int numParticipated;
        public int numBValidated;
        ...
        public ValidatorNode(int _vDeposit, int _vNumActivities) {
            vDeposit = _vDeposit;
            vNumActivities = _vNumActivities;
        }
        
        public ValidatorNode(int _vIdentifier, int _vDeposit, int _vNumActivities) {
            vIdentifier = _vIdentifier;
            vDeposit = _vDeposit;
            vNumActivities = _vNumActivities;
        }
        
        public ValidatorNode(int _vIdentifier, int _vDeposit, int _vNumActivities, int _vNumFailure, int _vWaitingTime, WorkerNode _wNode) {
            vIdentifier = _vIdentifier;
            vDeposit = _vDeposit;
            vNumActivities = _vNumActivities;
        ...
        public ValidatorNode(int _vIdentifier, int _vDeposit, int _vNumActivities, int _vNumFailure, int _vWaitingTime, RequesterNode _rNode) {
            vIdentifier = _vIdentifier;
            vDeposit = _vDeposit;
            vNumActivities = _vNumActivities;
            vNumFailure = _vNumFailure;
        ...
        public ValidatorNode(int _vIdentifier, int _vDeposit, int _vNumActivities, int _vNumFailure, int _vWaitingTime, BManagementNode _mNode) {
            vIdentifier = _vIdentifier;
            vDeposit = _vDeposit;
            vNumActivities = _vNumActivities;
            vNumFailure = _vNumFailure;
        ...
        public void AddAmount(int _vDeposit) {
        ...
        public int SubmitVDeposit(int _deposit) {
            eDeposit = _deposit;
            return eDeposit;
        }
        
        public int GetVEscrow(){
        	return eDeposit;
        }
        
        public void SetVDeposit(int _vDeposit) {
            vDeposit = _vDeposit;
        }

        public int GetVDeposit() {
            return vDeposit;
        }
        ...
        public void SetNumActivities(int _vNumActivities) {
            vNumActivities = _vNumActivities;
        }
        
        public void UpdateNumActivities(int _vNumActivities) {
            vNumActivities = this.vNumActivities + _vNumActivities;
        }
       
        public int GetNumBVAttempts() {
            return vNumActivities;
        }
       
       public void SetNumBVAttempts(int _vNumActivities) {
            vNumActivities = _vNumActivities;
        }
        
         public void IncNumBVAttempts(int _vNumActivities) {
        ...
        public int GetNumBValidated(){
        	return numBValidated;
        }
        
        public void SetNumBValidated(int _numBValidated){
        	numBValidated = _numBValidated;
        }
        
        public void IncNumBValidated(int _num){
        ...
        public void SetWaitingTime(int _vWaitingTime) {
            vWaitingTime = _vWaitingTime;
        }
        
        public void IncWaitingTime(int _vWaitingTime) {
	...
	public class ValidatorNodes : ExpressionValue {
        ...
        public int GetTNumBVAttempts() {
            int totalBVAttempts = 0;
            foreach (ValidatorNode vl in vlset) {
     ...
     public class WorkerNode : ExpressionValue {
        ...
        public int wDeposit;
        public int wNumActivities;
        public int wNumFailure;
        public int wWaitingTime;
        ...
        public WorkerNode(int _wDeposit, int _wNumActivities) {
            wDeposit = _wDeposit;
            wNumActivities = _wNumActivities;
        }
        
        public WorkerNode(int _wIdentifier, int _wDeposit, int _wNumActivities) {
            wIdentifier = _wIdentifier;
            wDeposit = _wDeposit;
            wNumActivities = _wNumActivities;
        }
        
        public WorkerNode(int _wIdentifier, int _wDeposit, int _wNumActivities, int _wNumFailure) {
            wIdentifier = _wIdentifier;
            wDeposit = _wDeposit;
            wNumActivities = _wNumActivities;
        ...
        public WorkerNode(int _wIdentifier, int _wDeposit, int _wNumActivities, int _wNumFailure, int _wWaitingTime) {
            wIdentifier = _wIdentifier;
            wDeposit = _wDeposit;
            wNumActivities = _wNumActivities;
            wNumFailure = _wNumFailure;
        ...
        public void SubmitWDeposit(int _wDeposit) {
            wDeposit = _wDeposit;
        }
        
        public void AddDeposit(int _wDeposit) {
        ...
        public void SetNumActivities(int _wNumActivities) {
            wNumActivities = _wNumActivities;
        }
        
        public void IncNumActivities(int _wNumActivities) {
	...
	public class RequesterNode : ExpressionValue {
        ...
        public int rDeposit;
        public int rNumActivities;
        public int rNumFailure;
        public int rWaitingTime;
        ...
        public RequesterNode(int _rDeposit, int _rNumActivities) {
            rDeposit = _rDeposit;
            rNumActivities = _rNumActivities;
        }
        
        public RequesterNode(int _rIdentifier, int _rDeposit, int _rNumActivities) {
            rIdentifier = _rIdentifier;
            rDeposit = _rDeposit;
            rNumActivities = _rNumActivities;
        }
        
        public RequesterNode(int _rIdentifier, int _rDeposit, int _rNumActivities, int _rWaitingTime) {
            rIdentifier = _rIdentifier;
            rDeposit = _rDeposit;
            rNumActivities = _rNumActivities;
        ...
        public RequesterNode(int _rIdentifier, int _rDeposit, int _rNumActivities, int _rNumFailure, int _rWaitingTime) {
            rIdentifier = _rIdentifier;
            rDeposit = _rDeposit;
            rNumActivities = _rNumActivities;
        ...
        public int SubmitRDeposit(int _rDeposit) {
            rDeposit = _rDeposit;
            return rDeposit;
        }
        
        public void AddDeposit(int _rDeposit) {
        ...
        public void SetNumActivities(int _rNumActivities) {
            rNumActivities = _rNumActivities;
        }
        
        public void UpdateNumActivities(int _rNumActivities) {
